        ...
        <Container>
          <Grid container spacing={6}>
                ...
                <CardContent>
                  <MKBox display="flex" justifyContent="center">
                    ...
                    <Modal open={open} onClose={handleClose} aria-labelledby="modal-title" aria-describedby="modal-description"  align="center">
                      <Box sx={style}>
                        <img src={guante} alt="Guantes Nitrile" style={{ width: "70%" }}/>
                      </Box>
                    </Modal>
                  </MKBox>
                </CardContent>
            ...
            <Grid item xs={12} md={6}>
              ...
              <p>Elaborado en nitrilo sin proteína de látex que cause alergia, fabricado bajo un riguroso sistema de calidad para proteger las manos.
                    No esterizados, ambidiestros, permite sensibilidad táctil y mejor agarre.</p>
            </Grid>
          </Grid>
          <MKBox mt={4}>
            ...
            <Box sx={{ p: 3 }}>
              ...
              {value === 1 && (
                ...
                <MKButton variant="contained" color="info" href="/fichaTecnica/FichaTecnica_Guantes_Nitrile.pdf" download>
                  Descargar Folleto
                </MKButton>
              </MKTypography>
              )}
